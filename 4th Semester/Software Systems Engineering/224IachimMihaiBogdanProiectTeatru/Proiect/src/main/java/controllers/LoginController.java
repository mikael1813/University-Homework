...
public class LoginController {
    ...
    public void event(MouseEvent mouseEvent) {
        Utilizator u = service.login(new Utilizator(txtUsername.getText(), txtParola.getText()));
        ...
        if (!u.getParola().equals(txtParola.getText())) {
            ...
            if (u.getClass() == Client.class) {
                ...
                try {
                    meniuClientController.setService(service, (Client) u);
                ...
                meniuAdministratorController.setService(service);
