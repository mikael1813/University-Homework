...
public class MeniuClientController {
    ...
    public void setService(ClientCtrl ctrl, Client client) throws AppException {
        this.ctrl = ctrl;
        this.client = client;
        initModelLocuri();
        start((Stage) tableViewLocuri.getScene().getWindow());
        System.out.println(ctrl.getSpectacolDeAzi());
        label.setText("Specatcolul "+ctrl.getSpectacolDeAzi().getNume());
    }
    ...
    public void initModelLocuri() throws AppException {
        initialize();
    ...
    public void eventRezerva(MouseEvent mouseEvent) throws AppException{
        modelProbe2.forEach(x -> {
            //try {
                //ctrl.rezerva(client, x);
    ...
    public void eventAddLoc(MouseEvent mouseEvent) throws AppException {
    ...
    public void eventDeleteSelectedLoc(MouseEvent mouseEvent) throws AppException {
