...
import com.example.project_kotlin_ma.DBHelper
import com.example.project_kotlin_ma.DBRepository
...
//        pret.setText("0")
        ...
        addBtn.setOnClickListener {
            ...
            if (nume.text.toString().isEmpty() || tip.text.toString()
                    .isEmpty() || cantitate.text.toString().isEmpty()
            ) {
