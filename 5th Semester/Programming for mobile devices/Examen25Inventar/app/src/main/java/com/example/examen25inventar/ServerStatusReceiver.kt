...
import com.example.examen25inventar.Operation
import java.io.File
...
class ServerStatusReceiver : BroadcastReceiver() {
    ...
    lateinit var produsViewModel: ProdusViewModel
...
//                    dbrepo.add(p)
//                }
//                produsViewModel.produse.value = dbrepo.getAll()
