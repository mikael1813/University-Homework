...
#
#     def __str__(self):
#         return 'ID: ' + str(self.id) + '   TITLE: ' + str(self.title) + '   DESC: ' + str(
#             self.desc) + '   GENRE: ' + str(self.genre)
#
# def write():
#     # data = {
#     #     'a': [1, 4.0, 3, 4+6j],
...
#     #     'c': {None, True, False}
#     # }
#     movie = Movie(1,"titlu",123,"Actiune")
#     movie1 = Movie(2,"titlu",123,"Actiune")
#     movie2 = Movie(3,"titlu",123,"Actiune")
#     list = [movie,movie1,movie2]
#
